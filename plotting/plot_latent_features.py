        ...
        if 1: #try:
            with h5py.File(i,'r') as f:
                ...
                if args.draw_feat is not None:
                    ...
                    feat = f['jet_features'][()][:,args.draw_feat]
...
plot(ax,sig_name,-1,whichfeat,[0.05,0.5,30],'yellow',0,show=False)
plot(ax,bkg_name,-1,whichfeat,[0.05,0.5,30],'yellow',0,show=False)
plot(ax,bkg_name,0,whichfeat,[0.05,0.5,30],'yellow',0,show=False)
plot(ax,sig_name,0,whichfeat,[0.05,0.5,30],'yellow',0,show=False)
plot(ax,bkg_name,1,whichfeat,[0.05,0.5,30],'yellow','fsrRenHi',show=False)
plot(ax,sig_name,1,whichfeat,[0.05,0.5,30],'yellow','fsrRenHi',show=False)
plot(ax,bkg_name,2,whichfeat,[0.05,0.5,30],'yellow','fsrRenLo',show=False)
plot(ax,sig_name,2,whichfeat,[0.05,0.5,30],'yellow','fsrRenLo',show=False)
plot(ax,bkg_name,3,whichfeat,[0.05,0.5,30],'yellow','herwig',show=False)
plot(ax,sig_name,3,whichfeat,[0.05,0.5,30],'yellow','herwig',show=False)
